...
import { ArrowLeft, Save, Plus, X, Upload, Loader2, Link as LinkIcon } from 'lucide-react';
import Link from 'next/link';
import { toast } from 'sonner';
import { savePartner } from '@/lib/partner-store';
    ...
    <div className="px-6 py-8 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="flex items-center justify-between">
          <h1 className="font-heading text-2xl font-extrabold text-white">Add New Partner</h1>
          <button
            type="submit"
            disabled={isSaving}
